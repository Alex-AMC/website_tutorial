...
export default function Home() {
  return (
    <div className="h-full bg-stone-800 overflow-auto">
      ...
      <Tab.Panels className="h-full bg-opacity-40 h-full max-w-[900px] w-full p-2 sm:p-4 my-6">
        <Tab.Panel className='overlow-auto'>
            <Masonry breakpointCols={2} className='flex gap-3' columnClassName=''>
              <img src="/AMP_1100.jpg" alt='Isal1' className='my-2'/> 
              <img src="/AMP04878.jpg" alt='Isal2' className='my-2'/> 
              <img src="/AMP07467.jpg" alt='Isal3' className='my-2'/> 
              <img src="/AMP07467.jpg" alt='Isal3' className='my-2'/> 
              <img src="/AMP07467.jpg" alt='Isal3' className='my-2'/> 
            </Masonry>
        </Tab.Panel>
